  ...
  return (
    <Menu>
      <MenuButton px={4} py={2} transition='all 0.2s'
                ...
                _hover={{ bg: 'gray.200' }} _expanded={{ bg: 'gray.300' }} _focus={{ boxShadow: 'outline' }}>
      ...
      <MenuList>
        ...
        <MenuDivider />
        <MenuItem onClick={() => handleMenuItemClick("Reports (ascending)")}>Ascending after number of reports</MenuItem>
        <MenuItem onClick={() => handleMenuItemClick("Reports (descending)")}>Descending after number of reports</MenuItem>
      </MenuList>
    </Menu>
  );
}

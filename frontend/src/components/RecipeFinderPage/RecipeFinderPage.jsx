            ...
            <Box w='100vw' h='90vh'>
                ...
                w='100%' h='100%'>
                    ...
                    <Flex flexDirection={isSmallScreen ? "column" : "row"}> 
                            ...
                            >
                                <Text fontSize="xl" fontWeight="bold">Results: {numberRecipes}</Text>
                                <Box overflowY="auto" maxWidth='100%' maxHeight={{base:"79vh", md:"80vh"}}
                                 minHeight={{base:"70.5vh", md:"80vh"}} className='scrollable-box' >
